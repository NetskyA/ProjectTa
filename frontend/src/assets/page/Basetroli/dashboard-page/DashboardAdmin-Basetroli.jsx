...
import Navbarside from "../../Basetroli/navbar/Navbarside-Basetroli.jsx";
import NavbarUp from "../../Basetroli/navbar/NavbarUp-Basetroli";
...
export default function DashboardAdminMaster() {
  ...
  const isMainPath = location.pathname === "/dashboard/adminpembelian";
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 mt-2">
                    {filteredOrders.map((o, i) => (
                      <div
                        ...
                        onDoubleClick={() =>
                          navigate(
                            `/dashboard/adminpembelian/menu/notapembelian/detail/${o.id}`
                          )
                        }
                      >
                        <div

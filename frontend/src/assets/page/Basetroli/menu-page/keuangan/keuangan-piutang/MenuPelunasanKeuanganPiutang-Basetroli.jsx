  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setData(filteredPelunasanData);
        setFilteredData(filteredPelunasanData);
      } catch (err) {
    ...
    <div className="py-14" style={{ fontFamily: "sans-serif" }}>
      ...
      <div className="flex items-center justify-center mb-2 relative">
        ...
        <div className="overflow-x-auto w-full" style={{ height: "56vh" }}>
          <table className="w-full text-xs text-left text-gray-500 border-collapse border" style={{width: "120vw"}}>
            <thead className="text-xs font-semibold text-blue-900 uppercase bg-gray-200">
              <tr>
                ...
                <th
                  scope="col"
                  className="px-1 py-1 w-20 cursor-pointer sticky top-0 border border-gray-700 bg-gray-200 z-10"
                  onClick={() => handleSort("nominal_bank")}
                >
                  Bank{" "}
                  {sortConfig.key === "nominal_bank" &&
                    (sortConfig.direction === "asc" ? " ▲" : " ▼")}
                </th>
                <th
                  scope="col"
                ...
                <th
                  ...
                  onClick={() => handleSort("biaya_affiliate")}
                >
                  Biaya Affiliate{" "}
                  {sortConfig.key === "biaya_affiliate" &&
                    (sortConfig.direction === "asc" ? " ▲" : " ▼")}
                </th>
                <th
                  scope="col"
                  className="px-1 py-1 w-20 cursor-pointer sticky top-0 border border-gray-700 bg-gray-200 z-10"
                  onClick={() => handleSort("trade_promo")}
                >
                  Trade Promo{" "}
                  {sortConfig.key === "trade_promo" &&
                    (sortConfig.direction === "asc" ? " ▲" : " ▼")}
                </th>
                <th
                  scope="col"
                  className="px-1 py-1 w-20 cursor-pointer sticky top-0 border border-gray-700 bg-gray-200 z-10"
                  onClick={() => handleSort("biaya_lain_lain")}
                >
                  Biaya Lain{" "}
                  {sortConfig.key === "biaya_lain_lain" &&
                    (sortConfig.direction === "asc" ? " ▲" : " ▼")}
                </th>
                {/* <th
                  scope="col"
                  className="px-1 py-1 w-28 cursor-pointer sticky top-0 border border-gray-700 bg-gray-200 z-10"
                  onClick={() => handleSort("pelunasan_terbayar")}
                >
                  Pelunasan{" "}
                  {sortConfig.key === "pelunasan_terbayar" &&
                    (sortConfig.direction === "asc" ? " ▲" : " ▼")}
                </th> */}
                <th
                  scope="col"

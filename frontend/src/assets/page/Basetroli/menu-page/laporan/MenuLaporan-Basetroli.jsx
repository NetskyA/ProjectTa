  ...
  return (
    <div className="py-14" style={{ fontFamily: "sans-serif" }}>
      ...
      <div className="bg-white rounded-md shadow-md">
        <div className="p-2">
          <div>
              <p className="text-xl font-semibold">Hasil Impossssrt</p>
            <div className="flex space-x-4 mb-2 mt-4">
              <div className="row text-xs">
                <p className="text-sm text-gray-500">Kode Barang</p>
                <select
                  className="border border-gray-300 w-32 h-8 px-1 py-1 rounded-sm"
                  value={kodePembelian}
              ...
              <div className="row text-xs">
                ...
                <input
                  type="text"
                  className="border border-gray-300 h-8 px-1 py-1 text-xs rounded-sm"
              ...
              <div className="row text-xs">
                ...
                <input
                  type="text"
                  className="border border-gray-300 px-1 h-8 py-1 text-xs rounded-sm"
                  placeholder="Harga"
                  value={
                    harga
          ...
          <div className="overflow-y-auto" style={{ height: "62vh" }}>
            <table className="table-auto border-collapse border text-sm border-gray-300 w-full">
              <thead className="">
                <tr>
                  <th className="py-1 px-1 border-b bg-gray-100 text-left sticky -top-1 z-10">
                    ID
                  </th>
                  <th className="py-1 px-1 border-b bg-gray-100 text-left sticky -top-1 z-10">
                    Nama Barang
              ...
              <tbody>
                {filteredData.map((item, index) => (
                  <tr key={index} className="hover:bg-gray-50 text-sm">
                    <td className="py-1 px-1 border-b">{item.id}</td>
                    <td className="py-1 px-1 border-b">{item.nama_barang}</td>
                    <td className="py-1 px-1 border-b">{item.jumlah}</td>

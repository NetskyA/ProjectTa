                  ...
                  return (
                    ...
                    >
                      ...
                      {expandedRows.includes(group.kode_packinglist) && (
                        <tr>
                          <td colSpan={4} className="pl-4 border border-gray-500">
                              ...
                              {(() => {
                                ...
                                const aggregatedDetails = Object.values(
                                  group.details.reduce((acc, item) => {
                                    // Kunci unik adalah gabungan kode_pemesanan dan kode_barang
                                    const key = `${item.kode_pemesanan}_${item.kode_barang}`;
                                    if (acc[key]) {
                                      // Jumlahkan quantity dan total_harga jika sudah ada
                                      acc[key].quantity += Number(item.quantity || 0);
                                      acc[key].total_harga += Number(item.total_harga || 0);
                                      return acc;
                                    }
                                    // Inisialisasi data dengan properti item, pastikan quantity dan total_harga sebagai angka
                                    acc[key] = {
                                      ...item,
                                ...
                                return (
                                  <table className="w-full text-xs text-left text-gray-900">
                                    ...
                                    >
                                      <tr>
                                        <th className="px-1 py-0.5 border border-gray-500 sticky top-0 z-10">
                                          Nota Jual
                                        </th>
                                        <th className="px-1 py-0.5 border border-gray-500 sticky top-0 z-10">
                                          Marketplace

// FILE: MenuInsertMasterKategori-Basetroli.jsx
import React, { useState, useEffect } from "react";
import { useSelector } from "react-redux";
import { useNavigate, Link } from "react-router-dom";
import {
  insertMasterKategori, getLaporanMasterToko, getLaporanMasterMarketPlace,
...
export default function MenuInsertMasterKategori() {
  ...
  useEffect(() => {
    const fetchToko = async () => {
      try {
        ...
        console.error("Error fetching basetroli toko:", err);
      }
    };
    fetchToko();
  }, [token]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        navigate("/dashboard/basetroli/menu/basetroli/kategori");
      }, 2000);
    } catch (err) {
    ...
    <div className="py-14 mb-10" style={{ fontFamily: "sans-serif" }}>
      ...
      <div className="head flex justify-between items-center">
        <div className="breadcrumb flex items-center">
          ...
          <Link to="/dashboard/basetroli/menu/basetroli/kategori" className="text-xs font-semibold text-blue-900">
            Master Kategori
          </Link>
          <div className="ml-1 mr-1">
            <svg
          ...
          <Link to="/dashboard/basetroli/menu/basetroli/kategori/insert" className="text-xs font-semibold text-gray-400">
            Tambah Kategori
          </Link>
        </div>
        <button
      ...
      <div className="bg-white flex rounded-md shadow-md p-4 justify-between items-center border border-gray-200 mb-1">
        ...
        <div className="flex space-x-2">
          <Link to="/dashboard/basetroli/menu/basetroli/kategori">

...
export default function NavbarUp() {
  ...
  return (
    <div className="flex justify-between items-center bg-white px-4 py-1 h-10 shadow-md" style={{ backgroundImage: `url(${BackgroundHeader})` }}>
      <div className="flex items-center">
        <p className=" text-white font-semibold capitalize text-xl">Double O Bakery - {username}</p>
      </div>

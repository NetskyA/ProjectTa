  ...
  return (
    <div ref={wrapperRef} className="relative w-full">
      ...
      <input
        ...
        className="border border-gray-300 text-xs bg-gray-200 rounded p-1 w-full pr-6" // pr-6 untuk ruang ikon ✕
      />
    ...
    <div className="py-14" style={{ fontFamily: "sans-serif" }}>
      ...
      <div className="head flex justify-between items-center">
        <div className="flex items-center">
          ...
          <Link
            to="/dashboard/master/menu/databarang"
            className="text-xs font-semibold text-blue-900"
          >
            Master Produk
          </Link>
...
<input
  ...
  className="mt-1 w-full border text-sm border-gray-300 rounded p-1 text-right"
...
<fieldset className="border border-blue-400 rounded-md p-2 w-52 shadow-sm">
  <legend className="text-sm font-bold text-blue-900">Perbarui</legend>
  ...
  {/* Catatan */}
  <div className="mt-2 border border-gray-400 rounded-md p-1 flex flex-col justify-start bg-gray-50">
    <p className="text-blue-900 font-semibold mb-0.5">Catatan:</p>
    <p className="text-xs italic text-gray-700 leading-snug overflow-hidden">
      {disableHarga ? (

  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        ...
        setTimeout(() => {
          navigate("/dashboard/master/menu/master/kategori");
        }, 2000);
      } else {
    ...
    <div className="py-14 mb-10" style={{ fontFamily: "sans-serif" }}>
      ...
      <div className="head flex justify-between items-center">
        <div className="breadcrumb flex items-center">
          ...
          <Link to="/dashboard/master/menu/master/kategori" className="text-xs font-semibold text-blue-900">
            Master Kategori
          </Link>
          <div className="mx-2">
            <svg
          ...
          <Link
            to={`/dashboard/master/menu/master/kategori/update/${id_kategori}`}

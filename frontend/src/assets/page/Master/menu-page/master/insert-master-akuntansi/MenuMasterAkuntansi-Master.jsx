...
export default function MenuMasterAkuntansiMaster() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Langsung set tanpa filter by id_toko:
        setData(dataRows);
  ...
  // Edit handler
  const handleEdit = (id) => {
    navigate(`/dashboard/master/menu/akuntansi/update/${id}`);
  };
    ...
    <div className="py-14 mb-10" style={{ fontFamily: "sans-serif" }}>
      ...
      <div className="head flex justify-between items-center">
        <div className="breadcrumb flex items-center">
          ...
          <Link to="/dashboard/master/menu/akuntansi" className="text-xs font-semibold text-gray-400">
            Master Akuntansi
          </Link>
        </div>
        <button
      ...
      >
        <div className="flex items-center justify-center mb-2 relative">
          ...
          <div className="absolute right-0 flex space-x-2">
            <Link to="/dashboard/master/menu/akuntansi/insert">

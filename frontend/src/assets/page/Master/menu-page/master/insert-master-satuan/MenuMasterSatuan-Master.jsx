    ...
    <div className="py-14" style={{ fontFamily: "sans-serif" }}>
      ...
      <div className="head flex justify-between items-center mb-0.5">
        <div className="cover flex items-center">
          ...
          <span className="text-xs font-semibold text-gray-400">Master Satuan</span>
        </div>
      ...
      <div className="bg-white rounded-md shadow-md border border-gray-200 p-1.5 max-w-4xl">
        <div className="flex items-center justify-center mb-2 relative">
          <p className="text-xl font-semibold text-blue-900 absolute left-1">Master Satuan</p>
          <div className="w-2/6">
          ...
          <div className="absolute right-0 flex space-x-2">
            <Link to="/dashboard/master/menu/master/satuan/insert">
            ...
            <tbody>
              {currentItems.length > 0 ? (
                currentItems.map((item, index) => {
                  ...
                  return (
                    <tr key={index} onDoubleClick={() => handleEdit(item.id_satuan)} className={`border-b hover:opacity-75 cursor-pointer text-gray-900 ${rowBg}`}>

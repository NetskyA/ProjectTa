...
export default function MenuReturNotaPembelianBasetroli() {
  ...
  // Hanya gunakan id_user jika diperlukan, tapi tidak filter berdasarkan id_toko
  ...
  const detailNotaJual = (id_retur_pembelian) => {
    ...
    navigate(`/dashboard/master/menu/notaretur/pembelian/proses/${id_retur_pembelian}`);
  };
    ...
    <div className="py-14" style={{ fontFamily: "sans-serif" }}>
      ...
      <div className="flex items-center justify-center mb-2 relative">
        ...
        <div className="w-fit flex absolute right-1 items-center justify-center bg-gray-200 rounded-md p-0.5 cursor-pointer">
          <button
            onClick={() =>
              navigate("/dashboard/master/menu/notaretur/pembelian/add")
            }
            ...
            <tbody>
              {currentItems.length > 0 ? (
                currentItems.map((item, index) => (
                  <tr key={`${item.kode_retur_pembelian}-${index}`} className="text-gray-900">
                ...
                <tr>
                  <td colSpan={6} className="py-4 px-1 text-center text-gray-500 border-b">

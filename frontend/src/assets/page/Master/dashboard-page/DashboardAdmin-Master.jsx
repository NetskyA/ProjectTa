  ...
  useEffect(() => {
    const fetchAll = async () => {
      try {
        ...
        /* ── posisi pesanan (header) dari struktur baru */
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex">
        ...
        {/* konten utama */}
        <div className="outlet ml-44 pl-3 -mt-3 mr-2 overflow-y-auto w-full">
          {isMainPath ? (
            <>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 mt-4">
                    {filteredOrders.map((o, i) => (
                      <div
                        ...
                        onDoubleClick={() =>
                          navigate(
                            `/dashboard/master/menu/pembelianbarang/detail/${o.id}`
                          )
                        }
                      >
                        <div
                        ...
                        <div
                          className="px-2 h-10 w-16 flex items-center justify-center font-semibold text-white rounded-r bg-amber-500"
                          style={{ fontSize: "12px" }}
                        >
                          {o.status}
                        </div>

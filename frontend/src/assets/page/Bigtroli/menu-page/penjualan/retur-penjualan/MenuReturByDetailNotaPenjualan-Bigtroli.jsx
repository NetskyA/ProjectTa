...
export default function MenuReturNotaDetailPenjualanBesttroli() {
  ...
  return (
    <div className="py-14" style={{ fontFamily: "sans-serif" }}>
      ...
      {/* Header Data */}
      <div className="bg-white rounded-md shadow-md p-4 mb-4 border border-gray-200">
      ...
      <div className="bg-white flex flex-col md:flex-row rounded-md shadow-md p-4 mb-4 border border-gray-200 gap-4">
        <FilterSelect
              ...
              <tbody>
                {filteredResultData.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="px-1 py-0.5 border border-gray-500">
                      {item.quantity_pemebelian !== undefined
                        ? item.quantity_pemebelian
                        : "0"}
                    </td>
                    <td className="px-1 py-0.5 border border-gray-500">

    ...
    <div className="py-14" style={{ fontFamily: "sans-serif" }}>
      ...
      <div className="head flex justify-between items-center">
        <div className="cover flex items-center">
          <Link
            to="/dashboard/bigtorlly/menu/notapenjualan"
          ...
          <table className="w-full text-xs text-left text-gray-500 border">
            <thead className="text-xs text-blue-900 uppercase bg-gray-200">
              <tr>
                ...
                <th
                  scope="col"
                  className="px-2 py-0.5 w-48 cursor-pointer sticky top-0 border border-gray-500 bg-gray-200 z-10"
                  onClick={() => handleSort("kode_barang")}
                >
                  Kode Barang
                  {sortConfig.key === "kode_barang" &&
                ...
                <th
                  scope="col"
                  className="px-2 py-0.5 cursor-pointer sticky top-0 border border-gray-500 bg-gray-200 z-10"
                >
                  DI BUAT TANGGAL
                </th>
                <th
                ...
                currentItems.map((item, index) => (
                  <tr
                    ...
                    className={`text-gray-900 ${
                      item.status_transaksi === "Lunas" ? "bg-lime-500" : item.status_transaksi === "Belum Lunas" ? "bg-yellow-300" : ""
                    }`}
                  >

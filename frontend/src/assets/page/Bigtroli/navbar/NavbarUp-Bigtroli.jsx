...
export default function NavbarUp() {
  ...
  return (
    <div className="flex justify-between items-center px-4 py-1 h-10 shadow-md" style={{ backgroundImage: `url(${BackgroundHeader})` }}>
      <div className="flex items-center">
      <Link
            to="/dashboard/adminkitchen"
            className="text-xs font-semibold text-blue-900"
          >
        <p className="text-white font-semibold text-xl">Double O Bakery - Admin Kitchen</p>
          </Link>
      </div>

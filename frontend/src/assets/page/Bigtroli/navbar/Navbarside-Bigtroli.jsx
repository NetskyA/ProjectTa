                  ...
                  <li className="m-1" data-aos="fade-right"  data-aos-duration="1000">
                    <Link
                      ...
                      className={`block py-1 px-2 text-xs text-white rounded-sm ${
                        location.pathname === "/dashboard/adminkitchen" ||
                        location.pathname === "/dashboard/adminkitchen"
                          ? "bg-slate-100 bg-opacity-30 rounded-sm hover:bg-blue-900"
                          : "hover:bg-blue-900 bg-opacity-30 rounded-sm"
                      }`}
                  ...
                  <li className="m-1" data-aos="fade-right"  data-aos-duration="1000">
                    <Link
                      ...
                      className={`block py-1 px-2 text-xs text-white rounded-sm ${
                        ...
                        location.pathname ===
                          "/dashboard/adminkitchen/menu/laporanpenjualan"
                          ? "bg-slate-100 bg-opacity-30 rounded-sm hover:bg-blue-900"
                          : "hover:bg-blue-900 bg-opacity-30 rounded-sm"
                      }`}
                    >
                  ...
                  <li className="m-1" data-aos="fade-right"  data-aos-duration="1600">
                    <Link
                      ...
                      className={`block py-1 px-2 text-xs text-white rounded-sm ${
                        ...
                        location.pathname ===
                          "/dashboard/adminkitchen/menu/laporanmasterbarang"
                          ? "bg-slate-100 bg-opacity-30 rounded-sm hover:bg-blue-900"
                          : "hover:bg-blue-900 bg-opacity-30 rounded-sm"
                      }`}
                    >
                  ...
                  <li className="m-1" data-aos="fade-right"  data-aos-duration="2400">
                    <Link
                      ...
                      className={`block py-1 px-2 text-xs text-white rounded-sm ${
                        ...
                        location.pathname ===
                          "/dashboard/adminkitchen/menu/laporanmasterbarangstok"
                          ? "bg-slate-100 bg-opacity-30 rounded-sm hover:bg-blue-900"
                          : "hover:bg-blue-900 bg-opacity-30 rounded-sm"
                      }`}
                    >
                  ...
                  <li className="m-1" data-aos="fade-right"  data-aos-duration="400">
                    <Link
                      ...
                      className={`block py-1 px-2 text-xs text-white rounded-sm ${
                        ...
                        location.pathname === "/dashboard/adminkitchen/menu/pembelianbarang"
                          ? "bg-slate-100 bg-opacity-30 rounded-sm hover:bg-blue-900"
                          : "hover:bg-blue-900 bg-opacity-30 rounded-sm"
                      }`}
                    >
                  ...
                  <li className="m-1" data-aos="fade-right"  data-aos-duration="400">
                    <Link
                      ...
                      className={`block py-1 px-2 text-xs text-white rounded-sm ${
                        ...
                        location.pathname === "/dashboard/adminkitchen/menu/import"
                          ? "bg-slate-100 bg-opacity-30 rounded-sm hover:bg-blue-900"
                          : "hover:bg-blue-900 bg-opacity-30 rounded-sm"
                      }`}
                    >
          ...
          <li className="mt-0 pt-0 m-2">
            ...
            {isProduksiOpen&& (
              <ul className="mt-1 pl-0.5 relative">
                  ...
                  <li className="m-1" data-aos="fade-right"  data-aos-duration="400">
                    <Link
                      ...
                      className={`block py-1 px-2 text-xs text-white rounded-sm ${
                        ...
                        location.pathname === "/dashboard/adminkitchen/menu/salesorder"
                          ? "bg-slate-100 bg-opacity-30 rounded-sm hover:bg-blue-900"
                          : "hover:bg-blue-900 bg-opacity-30 rounded-sm"
                      }`}
                    >
                ...
                {hasAccess("Gabungan permintaan") && (
                  <li className="m-1" data-aos="fade-right"  data-aos-duration="1000">
                    <Link
                      ...
                      className={`block py-1 px-2 text-xs text-white rounded-sm ${
                        location.pathname === "/dashboard/menu/gabunganpermintaan" ||
                        location.pathname === "/dashboard/adminkitchen/menu/gabunganpermintaan"
                          ? "bg-slate-100 bg-opacity-30 rounded-sm hover:bg-blue-900"
                          : "hover:bg-blue-900 bg-opacity-30 rounded-sm"
                      }`}
                    >
                  ...
                  <li className="m-1" data-aos="fade-right"  data-aos-duration="1600">
                    <Link
                      ...
                      className={`block py-1 px-2 text-xs text-white rounded-sm ${
                        ...
                        location.pathname === "/dashboard/adminkitchen/menu/produksiproduk"
                          ? "bg-slate-100 bg-opacity-30 rounded-sm hover:bg-blue-900"
                          : "hover:bg-blue-900 bg-opacity-30 rounded-sm"
                      }`}
                    >
                  ...
                  <li className="m-1" data-aos="fade-right"  data-aos-duration="2400">
                    <Link
                      ...
                      className={`block py-1 px-2 text-xs text-white rounded-sm ${
                        ...
                        location.pathname === "/dashboard/adminkitchen/menu/buktipengeluaran"
                          ? "bg-slate-100 bg-opacity-30 rounded-sm hover:bg-blue-900"
                          : "hover:bg-blue-900 bg-opacity-30 rounded-sm"
                      }`}
                    >
                ...
                {hasAccess("Nota Penjualan") && (
                  <li className="m-1" data-aos="fade-right"  data-aos-duration="3000">
                    <Link
                      to="menu/notapenjualan/adminkitchen"
                      className={`block py-1 px-2 text-xs text-white rounded-sm ${
                        location.pathname === "/dashboard/menu/notapenjualan/adminkitchen" ||
                        location.pathname === "/dashboard/adminkitchen/menu/notapenjualan/adminkitchen"
                          ? "bg-slate-100 bg-opacity-30 rounded-sm hover:bg-blue-900"
                          : "hover:bg-blue-900 bg-opacity-30 rounded-sm"
                      }`}
                    >
                  ...
                  <li className="m-1" data-aos="fade-right"  data-aos-duration="400">
                    <Link
                      ...
                      className={`block py-1 px-2 text-xs text-white rounded-sm ${
                        ...
                        location.pathname === "/dashboard/adminkitchen/menu/masterdatabarang"
                          ? "bg-slate-100 bg-opacity-30 rounded-sm hover:bg-blue-900"
                          : "hover:bg-blue-900 bg-opacity-30 rounded-sm"
                      }`}
                    >
                  ...
                  <li className="m-1" data-aos="fade-right"  data-aos-duration="1000">
                    <Link
                      ...
                      className={`block py-1 px-2 text-xs text-white rounded-sm ${
                        ...
                        location.pathname === "/dashboard/adminkitchen/menu/masterkategori"
                          ? "bg-slate-100 bg-opacity-30 rounded-sm hover:bg-blue-900"
                          : "hover:bg-blue-900 bg-opacity-30 rounded-sm"
                      }`}
                    >
                  ...
                  <li className="m-1" data-aos="fade-right"  data-aos-duration="1600">
                    <Link
                      ...
                      className={`block py-1 px-2 text-xs text-white rounded-sm ${
                        ...
                        location.pathname === "/dashboard/adminkitchen/menu/masterakun"
                          ? "bg-slate-100 bg-opacity-30 rounded-sm hover:bg-blue-900"
                          : "hover:bg-blue-900 bg-opacity-30 rounded-sm"
                      }`}
                    >
                  ...
                  <li className="m-1" data-aos="fade-right"  data-aos-duration="2400">
                    <Link
                      ...
                      className={`block py-1 px-2 text-xs text-white rounded-sm ${
                        ...
                        location.pathname === "/dashboard/adminkitchen/menu/masterakuntansi"
                          ? "bg-slate-100 bg-opacity-30 rounded-sm hover:bg-blue-900"
                          : "hover:bg-blue-900 bg-opacity-30 rounded-sm"
                      }`}
                    >
                  ...
                  <li className="m-1" data-aos="fade-right"  data-aos-duration="400">
                    <Link
                      ...
                      className={`block py-1 px-2 text-xs text-white rounded-sm ${
                        ...
                        location.pathname ===
                          "/dashboard/adminkitchen/menu/import/pelunasan"
                          ? "bg-slate-100 bg-opacity-30 rounded-sm hover:bg-blue-900"
                          : "hover:bg-blue-900 bg-opacity-30 rounded-sm"
                      }`}
                    >
                  ...
                  <li className="m-1" data-aos="fade-right"  data-aos-duration="400">
                    <Link
                      ...
                      className={`block py-1 px-2 text-xs text-white rounded-sm ${
                        ...
                        location.pathname === "/dashboard/adminkitchen/menu/transaksi/pelunasan"
                          ? "bg-slate-100 bg-opacity-30 rounded-sm hover:bg-blue-900"
                          : "hover:bg-blue-900 bg-opacity-30 rounded-sm"
                      }`}
                    >
                  ...
                  <li className="m-1" data-aos="fade-right"  data-aos-duration="400">
                    <Link
                      ...
                      className={`block py-1 px-2 text-xs text-white rounded-sm ${
                        ...
                        location.pathname ===
                          "/dashboard/adminkitchen/menu/pelunasankeuangan/piutang"
                          ? "bg-slate-100 bg-opacity-30 rounded-sm hover:bg-blue-900"
                          : "hover:bg-blue-900 bg-opacity-30 rounded-sm"
                      }`}
                    >

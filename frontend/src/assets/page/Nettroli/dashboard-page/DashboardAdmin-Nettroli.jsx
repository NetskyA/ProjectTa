// src/assets/page/Nettroli/dashboard-page/DashboardAdmin-Nettroli.jsx

import React from "react";
import Navbarside from "../../Nettroli/navbar/Navbarside-Nettroli";
import NavbarUp from "../../Nettroli/navbar/NavbarUp-Nettroli";
...
export default function DashboardAdminNettroli() { // Nama fungsi unik
...
if (currentHour >= 5 && currentHour < 11) {
  ...
  const isMainPath = location.pathname === "/dashboard/nettroli";
        ...
        <div className="outlet ml-40 mr-2 overflow-y-auto w-full">
          {isMainPath ? (
            <div className="text-2xl font-normal text-center mt-20">
              {greeting}, Selamat Datang di Dashboard Net Troli
            </div>
          ) : (
            <Outlet />
          )}

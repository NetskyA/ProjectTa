...
import { getNotaPenjualanNettroli } from "../../../services/apiService";
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const laporanData = await getNotaPenjualanNettroli(token);
  ...
  return (
    <div className="py-14" style={{ fontFamily: "sans-serif" }}>
      ...
      <div className="bg-white flex flex-col md:flex-row rounded-md shadow-md p-4 justify-between items-center border border-gray-200 mb-2">
        ...
        {/* Tombol Simpan & Cetak */}
        <div className="">
          <Link to="/dashboard/nettroli/menu/notapenjualan/detail">
